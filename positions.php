...
.style44 {font-size: x-large; font-family: "Trebuchet MS", verdana, tahoma, "Times New Roman"; color: #2C3091; font-weight: bold; }
.style46 {color: #2C3091; font-family: "Trebuchet MS", verdana, tahoma, "Times New Roman"; font-weight: bold; font-size: 16px; }
...
<table width="899" height="439" align="center" bgcolor="#B9E7F9">
  <tr>
    <td width="891" height="25" valign="top" class="style31" scope="col">
    <div align="left"><span class="style44">POSITIONS</span></div></td>
  </tr>
  <tr>
    <td height="83" valign="top" background="images1/bg.jpg" class="style31" scope="col"><style type="text/css">
...
$opts['sort_field'] = array('Position');
...
?></td>
  ...
  <tr>
    <td height="31" valign="top" class="style42" scope="col"><a href="departments.php"> <span class="style46">Back to</span><span class="style48"> Departments</span></a> , <a href="utilities.php" class="style48">Utilities</a></td>
  </tr>
  <tr>
    <td height="168" valign="top" background="images1/bg.jpg" class="style31" scope="col">
