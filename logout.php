  ...
  <tr>
    <th width="900" scope="col"><table width="900" background="images1/banner1.jpg">
        <tr>
          ...
          <th width="179" class="style19" scope="col"><div align="right" class="style19"></div></th>
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th background="images1/bg.jpg" bgcolor="#7DD1F3" scope="col"><p align="center">&nbsp;</p>
        <h1 align="center"><span class="err style39">LOGOUT</span></h1>
        <h1 align="center"><span class="err">You have been logged out.</span></h1><br></th>
  </tr>
  <tr>
    <th height="27" bgcolor="#7DD1F3" scope="col">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div align="center"><span class="style38">Click here to <a href="login-form.php">Login</a></span><br><br>
      </div></th>
  </tr>
</table>
<h1><a href="login-form.php">login</a></h1>
</body>
</html>
